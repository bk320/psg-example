...
## Para crear una copia de la lista se debe utilizar 
## el método copy() o el slicing [:]
...
#print (sum(lista))
#
#compuertas = [True, False, True, False, False]
#print (sum(compuertas))
...
#print ("Comparación de listas")
#lista1 = [1,2,3,4,5]
##lista2 = lista1 # Solo para probar la identidad en memoria
#lista2 = [1,2,3,4,5]
#lista3 = [1,2]
...
## Por que lista1 y lista2 son iguales, pero no son el mismo objeto en memoria

#print ("Menor y Menor Igual que")
#print ([1,2,3] <= [1,2,4]) #Compares elemento a elemento
#print ([1,2,3] <= [1,2,2,2])
#print ([1,2,3] <= [2])
#print ([1,2,3] < [1,2,3])
#print ([1,2,3] <= [1,2,3])
